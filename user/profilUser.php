...
<body>
    ...
    <div id="modalSupprimer" class="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="modal-titre">
        <div class="modal-box">
            <h2 id="modal-titre">⚠️ Supprimer mon compte</h2>
            <p>
                Cette action est <strong>irréversible</strong>.<br>
                Tous vos commentaires et données associées seront définitivement supprimés.
            </p>
            <div class="modal-actions">
                <button class="btn-cancel" onclick="document.getElementById('modalSupprimer').classList.remove('active')">
                    Annuler
                </button>
                <form action="../php/supprimerCompte.php" method="POST" style="flex:1;margin:0">
