<?php
    ...
    $reqCode->execute();
    //si le code existe pas ou est deja utilisé
    if ($reqCode->get_result()->num_rows === 0) {//num_row =nombre de résultat
    ...
    $req->bind_param("sssssss", $login, $mdpHash, $nom, $prenom, $tel, $email, $role); //s -> string
