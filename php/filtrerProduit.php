<?php
    ...
    $req="SELECT GROUP_CONCAT(nomProd SEPARATOR ', ') as listeProd, magasin.idMag, nomMag, adresse, codePostal, numMag, mailMag, ville, altitude, longitude, latitude, imgSrc, stock FROM produit
